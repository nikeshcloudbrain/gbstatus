...
public class StickerPackDetailsActivity extends AddStickerPackkkActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (stickerPreviewAdapter == null) {
            stickerPreviewAdapter = new StickerPreviewAdapter(getLayoutInflater(), R.drawable.sticker_error, getResources().getDimensionPixelSize(com.intuit.sdp.R.dimen._70sdp), getResources().getDimensionPixelSize(com.intuit.sdp.R.dimen._7sdp), stickerPack);
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle(showUpButton ? getResources().getString(R.string.title_activity_sticker_pack_details_multiple_pack) : getResources().getQuantityString(R.string.title_activity_sticker_packs_list, 1));
        }
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener pageLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            setNumColumns(recyclerView.getWidth() / recyclerView.getContext().getResources().getDimensionPixelSize(com.intuit.sdp.R.dimen._70sdp));
        }
    };
