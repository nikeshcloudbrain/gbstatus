...
public class StickerContentProvider extends ContentProvider {
    ...
    private List<com.gblatestversion.gbversion.gb.WhatsappSticker.StickerPack> stickerPackList;
    ...
    public boolean onCreate() {
        ...
        for (com.gblatestversion.gbversion.gb.WhatsappSticker.StickerPack stickerPack : getStickerPackList()) {
            MATCHER.addURI(authority, STICKERS_ASSET + "/" + stickerPack.identifier + "/" + stickerPack.trayImageFile, STICKER_PACK_TRAY_ICON_CODE);
            for (com.gblatestversion.gbversion.gb.WhatsappSticker.Sticker sticker : stickerPack.getStickers()) {
    ...
    private synchronized void readContentFile(@NonNull Context context) {
        try (InputStream contentsInputStream = context.getAssets().open(CONTENT_FILE_NAME)) {
            stickerPackList = com.gblatestversion.gbversion.gb.WhatsappSticker.ContentFileParser.parseStickerPacks(contentsInputStream);
        } catch (IOException | IllegalStateException e) {
            throw new RuntimeException(CONTENT_FILE_NAME + " file has some issues: " + e.getMessage(), e);
        }
    }

    private List<com.gblatestversion.gbversion.gb.WhatsappSticker.StickerPack> getStickerPackList() {
    ...
    @NonNull
    private Cursor getStickerPackInfo(@NonNull Uri uri, @NonNull List<com.gblatestversion.gbversion.gb.WhatsappSticker.StickerPack> stickerPackList) {
        ...
        for (com.gblatestversion.gbversion.gb.WhatsappSticker.StickerPack stickerPack : stickerPackList) {
